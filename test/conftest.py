...
def movie_dao():
    ...
    movie_1 = Movie(id=1, title="one + one", description="Description 1", trailer="link 1",
                    year=2000, rating=10.0, genre_id=1, director_id=1)
    movie_2 = Movie(id=2, title="Vicing", description="Description 2", trailer="link 2",
                    year=2001, rating=9.0, genre_id=2, director_id=2)
    movie_3 = Movie(id=3, title="Mask", description="Description 3", trailer="link 3",
                    year=2002, rating=8.0, genre_id=3, director_id=3)
